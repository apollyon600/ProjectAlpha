...
module.exports = class {
    static async run(client) {
        ...
        setInterval(function() { client.user.setActivity(config.statuses[Math.floor(Math.random() * config.statuses.length)].replace(/{guild}/g, client.guilds.cache.size), { type: "WATCHING" }) }, 3600000);
